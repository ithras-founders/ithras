...
export const PRODUCT_ROUTES = [
  ...
  { views: ['messages'], flags: ['isGeneralUser'], product: 'general-feed' },
  { views: ['messages'], flags: ['isCandidate', 'isRecruiter'], product: 'general-feed' },
  { views: ['messages'], flags: ['isRestrictedUser'], product: 'general-feed' },
  { views: ['dashboard'], flags: ['isSystemAdmin'], product: 'system-admin' },
  { views: ['dashboard', 'general_feed', 'feed', 'my-network'], flags: ['isGeneralUser'], product: 'general-feed' },
  { views: ['feed', 'my-network'], flags: ['isCandidate', 'isRecruiter'], product: 'general-feed' },
  { views: ['feed', 'general_feed', 'my-network'], flags: ['isRestrictedUser'], product: 'general-feed' },
  ...
  { views: ['preparation'], flags: ['isCandidate'], product: 'preparation' },
  { views: ['preparation'], flags: ['isRestrictedUser'], product: 'preparation' },
  { views: ['dashboard', 'applications', 'active_processes', 'intelligence', 'calendar'], flags: ['isInstitutionallyRestrictedCandidate'], product: 'general-feed' },
