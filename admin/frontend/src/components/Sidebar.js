 ...
 * Width coordinated with BrandArea: 240px expanded, 72px collapsed.
 */
 ...
 * }} props
 */
const Sidebar = ({ collapsed, activeTab, onLogout }) => {
  ...
  return html`
    ...
    >
      ...
      <div className="relative flex-shrink-0 p-3 pt-2 border-t border-[var(--app-border-soft)]" ref=${ref}>
        ${settingsOpen ? html`
          <div
            className="absolute bottom-full left-3 right-3 mb-1 py-1 bg-[var(--app-surface)] border border-[var(--app-border-soft)] rounded-lg shadow-lg z-10"
            role="menu"
          >
            <button
