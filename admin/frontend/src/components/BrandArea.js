 ...
 * Width matches sidebar; logo alignment adjusts for expanded vs collapsed.
 * Expanded: logo centered. Collapsed: compact, left-aligned.
 */
  ...
  return html`
    ...
    >
      ...
      >
        <a
          href="/"
          className=${`flex items-center min-w-0 overflow-visible ${collapsed ? 'flex-1 justify-center' : 'flex-1 justify-center'}`}
          aria-label="Ithras home"
        >
          <${IthrasLogo}
