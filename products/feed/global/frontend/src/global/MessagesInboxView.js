  ...
  return html`
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row gap-4 h-[calc(100vh-12rem)] min-h-[400px]">
        <div className="w-full sm:w-80 flex-shrink-0 border border-[var(--app-border-soft)] rounded-xl bg-[var(--app-surface)] overflow-hidden flex flex-col shadow-[var(--app-shadow-subtle)]">
        ...
        <div className="flex-1 flex flex-col border border-[var(--app-border-soft)] rounded-xl bg-[var(--app-surface)] overflow-hidden min-h-0 shadow-[var(--app-shadow-subtle)]">
          ${selectedConvId
            ? html`
